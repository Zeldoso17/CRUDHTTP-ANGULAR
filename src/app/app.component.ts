...
export class AppComponent implements OnInit {
  ...
  save(){
    ...
    if (this.brandForm.invalid) {
      ...
      if(!id){
        ...
        this._http.put(this.baseURL+'crud_brands/'+id, this.brandForm.value).subscribe(() => {
  ...
  getAll(){
    ...
    this._http.get(this.baseURL+'crud_brands/').subscribe((result) => {
      this.brandList = result ? result['brands'] : [];
    });
  }
  ...
  edit(id){
    if(id){
      ...
      this._http.get(this.baseURL+'crud_brands/'+id).subscribe((result) => {
  ...
  delete(id){
    ...
    if(id && result){
      ...
      this._http.delete(this.baseURL+'crud_brands/'+id).subscribe(() => {
        brand.isReading = false;
        this.reset();
